...
<h2> Database Query for Lund </h2>
<body>
<p>This test page is making a database query for any employees who have the last name Lund in alphabetical order</p>
<?php

//this is the php object oriented style of creating a mysql connection
$conn = new mysqli('localhost', 'lt', '123', 'employees' );
...
$sql = "SELECT first_name,last_name,hire_date FROM employees where last_name = 'Lund' order by first_name";
